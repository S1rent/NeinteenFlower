...
namespace NeinteenFlower.Controller
{
    ...
    {
        UpdateMemberHandler handler = new UpdateMemberHandler();

        public MsMember GetMemberByID(int id)
        {
            return handler.GetMemberByID(id);
        }
        ...
        public string UpdateMember(int id, string email, string password, string name, string birthDate,
                               bool isMale, bool isFemale, string phoneNumber, string address, string currentEmail)
        {
