...
namespace NeinteenFlower_FrontEnd.localhost {
    using System;
    ...
    public partial class NeinteenFlowerWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback checkUserEmailExistOperationCompleted;
        ...
        public NeinteenFlowerWebService() {
            this.Url = global::NeinteenFlower_FrontEnd.Properties.Settings.Default.NeinteenFlower_FrontEnd_localhost_NeinteenFlowerWebService;
        ...
        /// <remarks/>
        public event checkUserEmailExistCompletedEventHandler checkUserEmailExistCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/checkUserEmailExist", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string checkUserEmailExist(string email) {
            object[] results = this.Invoke("checkUserEmailExist", new object[] {
                        email});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void checkUserEmailExistAsync(string email) {
            this.checkUserEmailExistAsync(email, null);
        }
        
        /// <remarks/>
        public void checkUserEmailExistAsync(string email, object userState) {
            if ((this.checkUserEmailExistOperationCompleted == null)) {
                this.checkUserEmailExistOperationCompleted = new System.Threading.SendOrPostCallback(this.OncheckUserEmailExistOperationCompleted);
            }
            this.InvokeAsync("checkUserEmailExist", new object[] {
                        email}, this.checkUserEmailExistOperationCompleted, userState);
        }
        
        private void OncheckUserEmailExistOperationCompleted(object arg) {
            if ((this.checkUserEmailExistCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.checkUserEmailExistCompleted(this, new checkUserEmailExistCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void checkUserEmailExistCompletedEventHandler(object sender, checkUserEmailExistCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class checkUserEmailExistCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal checkUserEmailExistCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
